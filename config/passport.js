        ...
        function(req, username, password, done) {
            ...
            Account.find({
                ...
                if (result.docs.length === 0) {
                    ...
                    return done(null, false, "Usuário ou senha incorretos.");
                }
                ...
                if (bcrypt.compareSync(password, user.password)) {
                    ...
                    return done(null, null, "Usuário ou senha incorretos.");
                }
            });
        }
    ));
        ...
        function(req, username, password, done) {
            ...
            Account.find({
                ...
                if (err) {
                    ...
                    return done(null, null, "Usuário já existe. Use outas informações ou faça login.");
                }
