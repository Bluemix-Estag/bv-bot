        ...
        buildContextObject(req, function (err, params) {
            ...
            if (params.message) {
                ...
                conversation.message(params, function (err, data) {
                    ...
                    if (data['context']['carro'] && data['context']['modelo']) {
                        var options = {
                        ...
                        var options2 = {
                            url: "https://voto-sample.mybluemix.net/sample?period=" + data['context']['period'] + "&entry=" + data['context']['entry'] + "&total=" + data['context']['preco']
                            , // temos que setar o carro escolhido e depois escolher ele no vetor info[i][3] que retorna o preco para a api de financiamento
                            headers: {
                                Accept: 'text/json'
                            }
                        };
